...
const astrologyMessage = (Array) => {
    ...
    messageToShow.push(` As prediction Your Sign is "${Array[0]}" \nSo,You were born between ${timesOfBorn[birthOfdate]}`);
    messageToShow.push(`You are having a  ${Array[1]}`);
    messageToShow.push(`As Advice  "${Array[2]}"`);
